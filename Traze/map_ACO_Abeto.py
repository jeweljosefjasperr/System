...
class BrowserLayout(BoxLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.browser_widget = CefBrowser1()
...
class CefBrowser1(Screen):
    ...
    def __init__(self, start_url='file://D:\Traze\ACO_Abeto_to_Balantang.html', **kwargs):
        super(CefBrowser1, self).__init__(**kwargs)
