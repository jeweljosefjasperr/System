...
class BrowserLayout(BoxLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.browser_widget = CefBrowser2()
...
class CefBrowser2(Screen):
    ...
    def __init__(self, start_url='file://D:\Traze\Abeto_To_Balantang.html', **kwargs):
        super(CefBrowser2, self).__init__(**kwargs)
