...
class BrowserLayout(BoxLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.browser_widget = CefBrowser5()
...
class CefBrowser5(Screen):
    ...
    def __init__(self, start_url='file://D:\Traze\ACO_Mohon_to_Bakhaw.html', **kwargs):
        super(CefBrowser5, self).__init__(**kwargs)
