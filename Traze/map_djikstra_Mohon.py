...
class BrowserLayout(BoxLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self.browser_widget = CefBrowser6()
...
class CefBrowser6(Screen):
    ...
    def __init__(self, start_url='file://D:\Traze\Mohon_To_Bakhaw.html', **kwargs):
        super(CefBrowser6, self).__init__(**kwargs)
